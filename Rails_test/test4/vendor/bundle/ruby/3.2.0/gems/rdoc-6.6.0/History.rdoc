...
* Minor enhancements
  ...
  * HTML headings now have ids matching their names.
...
* Minor enhancements
  ...
  * Last <tt>--name</tt> wins.  Patch by Thierry Lambert.
...
* 8 Minor Enhancements
  * RDoc now adds the package name to the web pages that it generates
