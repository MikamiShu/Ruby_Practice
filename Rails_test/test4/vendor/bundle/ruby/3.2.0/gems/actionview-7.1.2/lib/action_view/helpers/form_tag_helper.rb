...
module ActionView
  module Helpers # :nodoc:
    ...
    module FormTagHelper
      ...
      #
      #   <%= label_tag :post, :name %>
      #   <%= text_field_tag :post, :name, aria: { describedby: field_id(:post, :name, :error) } %>
      #   <%= tag.span("is blank", id: field_id(:post, :name, :error) %>
      #
      ...
      # attribute name.
      #
      #   <%= text_field_tag :post, :name, name: field_name(:post, :name, :subname) %>
      ...
      #
      # <tt>legend</tt> will become the fieldset's name (optional as per W3C).
